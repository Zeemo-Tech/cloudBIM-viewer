...
// 标尺图标随包发布（构建时内联为 data URI），不再依赖宿主 public 目录。
import rulerIcon from '@/assets/celiang.svg'
...
<template>
  ...
  >
    ...
    >
      ...
      <img v-else-if="props.toggleIcon === 'ruler' || collapsed" class="measurement-toggle-icon" :src="rulerIcon" alt="" />
