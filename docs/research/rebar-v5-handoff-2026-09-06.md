...
> 续作状态见 [rebar-v5-recovery-2026-09-06.md](rebar-v5-recovery-2026-09-06.md)。旧工作已保存在 `e23206c`；修复提交为 `932694d`、`3d2ff7c`。198 项 Python 测试和三个开发场景通过，但首次冻结留出验收失败，尚未启动新的真实 benchmark，默认入口已恢复 V3。下文保留暂停时的原始证据，不代表最新状态。
