    ...
    <div class="upload-stage">
      ...
      <div class="upload-controls-shell">
        ...
        <div class="archive-fields">
          <div class="archive-field"><span>楼栋</span><el-input v-if="activeTab !== 'pointcloud'" v-model="archiveForm.building" placeholder="如 2#" clearable /><el-select v-else v-model="archiveForm.building" filterable allow-create default-first-option clearable :loading="designModelsLoading" no-data-text="当前项目没有带归档信息的 ready BIM" placeholder="楼栋"><el-option v-for="item in buildings" :key="item" :label="item" :value="item" /></el-select></div>
...
<style scoped>
.simple-upload-page{background:linear-gradient(135deg,#f9fafb 0%,#f1f6ff 100%)}
...
.locked-type-badge{width:35px;height:15px;display:grid;place-items:center;color:#2563eb;}
.locked-type-badge :deep(.el-icon){font-size:22px}
.simple-upload-page.is-compact{min-height:560px;height:auto;}
...
@media(max-height:760px){.simple-upload-page.is-compact{min-height:510px}.simple-upload-page.is-compact .upload-stack-wrapper{margin-block:-22px 30px;transform:scale(.84)}.simple-upload-page.is-compact .control-bar{margin-top:-8px}}
...
/* Keep the upload dialogs compact without changing the full upload page. */
.simple-upload-page.is-compact .upload-stack-wrapper{max-width:38rem;margin-bottom:36px}
.simple-upload-page.is-compact .stack-layer-3{width:400px;height:310px}
.simple-upload-page.is-compact .stack-layer-2,.simple-upload-page.is-compact .stack-layer-1{width:420px;height:330px}
.simple-upload-page.is-compact .main-upload-card{width:400px;height:310px;border-radius:2.5rem}
.simple-upload-page{scrollbar-width:none;scrollbar-gutter:auto}
.simple-upload-page::-webkit-scrollbar{display:none;width:0;height:0}
@media(min-width:761px){
  .simple-upload-page.is-compact .archive-form.has-scan-date .archive-fields>:nth-child(1),
  .simple-upload-page.is-compact .archive-form.has-scan-date .archive-fields>:nth-child(2){flex:.78 1 0}
  .simple-upload-page.is-compact .archive-form.has-scan-date .archive-fields>:nth-child(5){flex:1.45 1 0}
}
</style>
